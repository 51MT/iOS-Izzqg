...
- (void)setDefaultValues {
    ...
    _attributes = @[ @"you", @"should", @"set", @"these", @"data", @"titles,", @"this", @"is", @"just", @"a", @"placeholder" ];
...
- (void)drawRect:(CGRect)rect {
    ...
    [[UIColor colorWithRed:(CGFloat) 0xb6 / (CGFloat) 0xff green:(CGFloat) 0xcb / (CGFloat) 0xff blue:(CGFloat) 0xdf / (CGFloat) 0xff alpha:1.0f] setStroke];
