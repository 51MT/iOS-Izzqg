...
@interface CGAccountSetViewController ()
{
...
@implementation CGAccountSetViewController
...
-(void)initUI
{
    ...
    idNumberLab.text = @"420621199006061856";
    ...
    dbdrxeLab.text = [NSString stringWithFormat:XYBString(@"str_cgdbxetips", @"单笔限额%@万 | 单日限额%@万"),@"20",@"5"];
