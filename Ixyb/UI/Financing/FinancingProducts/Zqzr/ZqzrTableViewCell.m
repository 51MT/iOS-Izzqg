...
@implementation ZqzrTableViewCell {
...
- (void)createMainUI {
    ...
    //出借按钮
    _investButton = [[ColorButton alloc] initWithFrame:CGRectMake(0, 0, 90, 40) Title:XYBString(@"str_financing_panicBuy", @"出借") ByGradientType:leftToRight];
