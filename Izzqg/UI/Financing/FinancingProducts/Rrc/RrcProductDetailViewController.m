...
@interface RrcProductDetailViewController ()
{
...
@implementation RrcProductDetailViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self requestRrcProductDetailWebserviceWithParam:paramMatching];
}
...
- (void)refreshUI:(XsdDetailResponseModel *)model {
    ...
    self.navItem.title = [NSString stringWithFormat:@"人人车-%@",model.product.title];
...
- (void)requestRrcProductDetailWebserviceWithParam:(NSDictionary *)param {
