//
//  XsdProductDetailViewController.m
//  Ixyb
//
...
@interface XsdProductDetailViewController ()
...
@implementation XsdProductDetailViewController {
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self requestXsdProductDetailWebserviceWithParam:paramMatching];
}
...
- (void)refreshUI:(XsdDetailResponseModel *)model {
    ...
    self.navItem.title = [NSString stringWithFormat:@"信闪贷-%@",model.product.title];
...
- (void)requestXsdProductDetailWebserviceWithParam:(NSDictionary *)param {

    NSString *requestURL = [RequestURL getRequestURL:XsdMatchingProductURL param:param];
