//
//  AddressProvinceViewController.m
//  Ixyb
//
...
@interface AddressProvinceViewController () {
...
@implementation AddressProvinceViewController

- (void)setNav {

    self.navItem.title = XYBString(@"string_choose_province", @"选择省市");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    AddressCityViewController *cityVC = [[AddressCityViewController alloc] init];
