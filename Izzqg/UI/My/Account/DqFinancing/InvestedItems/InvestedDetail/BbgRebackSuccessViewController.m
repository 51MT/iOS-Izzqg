//
//  BbgRebackSuccessViewController.m
//  Ixyb
//
...
@interface BbgRebackSuccessViewController ()

@end

@implementation BbgRebackSuccessViewController
...
{
    LendStateViewController * lendState = [[LendStateViewController alloc] init];
