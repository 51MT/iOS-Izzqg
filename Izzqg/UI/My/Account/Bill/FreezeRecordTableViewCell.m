...
@implementation FreezeRecordTableViewCell
...
- (void)setRecord:(FreezeListRecord *)record {
    ...
    lab2.text = [NSString stringWithFormat:@"- %@", [Utility replaceTheNumberForNSNumberFormatter:[NSString stringWithFormat:@"%.2f", record.amount]]];
