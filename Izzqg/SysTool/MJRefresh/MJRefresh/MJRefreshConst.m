...
const CGFloat MJRefreshHeaderHeight = 48.0;
...
NSString *const MJRefreshHeaderPullingText = @"释放立即刷新";
...
NSString *const MJRefreshAutoFooterNoMoreDataText = @"加载成功";

NSString *const MJRefreshBackFooterIdleText = @"上拉加载更多";
NSString *const MJRefreshBackFooterPullingText = @"释放立即加载";
