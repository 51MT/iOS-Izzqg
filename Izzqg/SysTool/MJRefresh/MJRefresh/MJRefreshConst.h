...
// 文字颜色
#define MJRefreshLabelTextColor MJRefreshColor(100.0f, 100.0f, 100.0f)
#define MJRefreshDetailLabelTextColor MJRefreshColor(110.0f, 110.0f, 110.0f)

// 字体大小
#define MJRefreshLabelFont [UIFont boldSystemFontOfSize:15.0f]
#define MJRefreshDetailLabelFont [UIFont systemFontOfSize:13.0f]
