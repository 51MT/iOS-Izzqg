...
@property (nonatomic, strong) NSArray *labelVauleArr; //LabelForIndex
@property (nonatomic, strong) NSArray *labelIndexArr; //LabelForIndex
@property (nonatomic) CGFloat leftVauleMax;
